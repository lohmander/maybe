...
type AnyMaybe<T> = Maybe<T> | AsyncMaybe<T>;
type ExtractMaybeArrayValue<M extends ReadonlyArray<Maybe<any> | AsyncMaybe<any>>> = M[number] extends AnyMaybe<infer T> ? T : never;
...
declare class Maybe<T> {
     ...
     */
    first<Us extends ReadonlyArray<Maybe<any>>>(fn: (value: T) => Us): Maybe<ExtractMaybeArrayValue<Us>>;
    /**
